            ...
            <div class="container">
                ...
                <form role="form" method="post" target="preview" id="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="imagem" name="Sender[link1]" placeholder="Digite o link">
                    </div>
                    <div class="form-group">
                        <label for="Email">imagem 2</label>
                        <input type="text" class="form-control" id="Email" name="Sender[email]" placeholder="Digite a url fonte">
                        <input type="text" class="form-control" id="imagem" name="Sender[link2]" placeholder="Digite o link">
                    </div>
                    <div class="form-group">
                        <label for="Phone">Imagem 3</label>
                        <input type="text" class="form-control" id="Phone" name="Sender[phone]" placeholder="Digite a url fonte">
                        <input type="text" class="form-control" id="imagem" name="Sender[link3]" placeholder="Digite o link">
                    </div>
                    <div class="form-group">
                        <label for="Mobile">imagem 4</label>
                        <input type="text" class="form-control" id="Mobile" name="Sender[mobile]" placeholder="Digite a url fonte">
                        <input type="text" class="form-control" id="imagem" name="Sender[link4]" placeholder="Digite o link">
                    </div>
